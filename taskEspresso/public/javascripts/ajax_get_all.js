    ...
    xhr.onreadystatechange = function () 
    {
        if (xhr.readyState == 4) 
        {
            ...
            if(liste_taches.innerHTML === "")
            {
                ...
                {
                    liste_taches.innerHTML += '<div class="card"><h2>' + myObj[i].post_title + '</h2><br><div style=width:100%;font-weight:100;font-size:1.2rem;background-color:#ffcc66;color:black;>' + myObj[i].post_content + '<p>'+ myObj[i].post_date+'</p></div><div>Supprimer</div></div>';                
                }
            }
            else
            {
